...
import { useHotkey } from "@/website/hooks/use-hotkey";
import { useDebounce } from "@/website/hooks/use-debounce";
import { searchProducts, PRODUCTS } from "@/website/data/products";
