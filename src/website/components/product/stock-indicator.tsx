...
import type { Size, Product } from "@/website/types";
 ...
 * - If a size is selected and it's sold out â†’ "Sold out — pick another size"
 * - If selected and stock <= LOW_THRESHOLD â†’ "Only N left in {size}"
 * - If no size selected and at least one size has low stock â†’ generic "Selling fast"
