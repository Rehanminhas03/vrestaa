...
import { Marquee } from "@/website/components/animations/marquee";
import { ROUTES } from "@/website/constants/routes";
import { ensureGsap, ScrollTrigger } from "@/website/lib/gsap";
import { EASE_OUT_EXPO } from "@/website/lib/motion";
      ...
      <Container size="wide" className="relative z-10 flex flex-1 flex-col justify-end pb-20 pt-32 md:pt-44">
        ...
        >
          ...
          <div className="hidden gap-8 sm:flex md:gap-12">
            ...
            <CountStat value={4.9} suffix="â˜…" label="Avg rating" decimals={1} />
          </div>
        </motion.div>
      </Container>
    </section>
