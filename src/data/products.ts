...
// Inventory pattern → per-size stock map. Lets us write `stock(sizes, "low-mid-out")`
...
export const PRODUCTS: Product[] = [
  ...
  // ─────────────────────── POLOS ───────────────────────
  {
    ...
    currency: "USD",
    description:
      "Off-floor polish without the dress shirt stiffness. Technical piqué with a clean placket.",
    features: [
      "Technical piqué knit",
